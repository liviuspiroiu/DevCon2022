...
//
//import static com.example.devcon.common.enums.ProductStatus.AVAILABLE;
...
//
////        final OrderDto order = orderService.
//
//        assertEquals(new OrderDto(
//                2L,
//                BigDecimal.valueOf(180000, 2),
...
//
//        final OrderDto order = OrderService.mapToDto(orderService.findById(2L).orElseThrow());
//
//        assertEquals(new OrderDto(
//                2L,
